...
public class RadioAccessFamily implements Parcelable {
    ...
    public static final int RAF_HP = (1 << ServiceState.RIL_RADIO_TECHNOLOGY_HP);
    // 4G
    ...
    private static final int HS = RAF_HSUPA | RAF_HSDPA | RAF_HSPA | RAF_HSPAP | RAF_HP;
